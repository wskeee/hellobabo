...
class DefaultController extends Controller {
    ...
    public function actionCreate() {
        ...
        $owners = AdminUser::findAll(['type' => AdminUser::TYPE_OWNER, 'status' => AdminUser::STATUS_ACTIVE]);
        ...
        return $this->render('create', ['model' => $model, 'owners' => $owners]);
    }
    ...
    public function actionUpdate($id) {
        ...
        if ($model->load(Yii::$app->getRequest()->post())) {
            ...
            $model->password_hash = '';
            return $this->render('update', ['model' => $model, 'owners' => $owners]);
        }
    }
